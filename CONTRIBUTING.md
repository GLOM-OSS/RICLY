...
Please note that this project is released with a [Contributor Code of Conduct][code-of-conduct] and a [licence][LICENCE]. By participating in this project you agree to abide by these terms.
...
2. Configure and run by following the [README][README] file.
3. Create a new branch: `git checkout -b feature/my-branch-name`.
4. Work on your issue/feature
5. Before committing the changes run tests using `yarn test`
6. Follow [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for writing commit messages
7. Push to your fork and [submit a pull request][pr] in `develop` branch
